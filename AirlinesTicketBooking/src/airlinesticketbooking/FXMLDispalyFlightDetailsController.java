 ...
 * @author Admiin
 */
public class FXMLDispalyFlightDetailsController {
    ...
    private void handleButtonAction (ActionEvent event) throws Exception {
        ...
        else if(event.getSource()==kttosinbookbt){
//            stage = (Stage) kttosinbookbt.getScene().getWindow();
//            root = FXMLLoader.load(getClass().getResource("FXMLBookNow.fxml"));
                loadSceneAndSendMessage();

        }
        else if(event.getSource()==sgtoklbookb){
//            stage = (Stage) sgtoklbookb.getScene().getWindow();
//            root = FXMLLoader.load(getClass().getResource("FXMLBookNow.fxml"));
                loadSceneAndSendMessage();
        }
        else{
